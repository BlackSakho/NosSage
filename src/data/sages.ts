...
export const sages: Sage[] = [
  {
    ...
    quotes: [
      {
        id: 'c1',
        text: 'Dieu est loin d’être un élément de recul dont la seule préoccupation est de remuer les brasiers de l’Enfer',
        source: 'Al Macktoom'
      },
      {
        id: 'c2',
        text: 'La loi coranique n’est loi que quand il y a des hommes capables d’en faire un ferment et un ferment purement du progrès.',
        source: 'Al Macktoom'
      },
      
        {
          id: 'c26',
          text: 'L’Islam a perdu de sa signification actuelle, en ce sens que les adeptes le méconnaissent et, partant le défigurent',
          source: 'Al Macktoom'
        },
        {
          id: 'c27',
          text: 'Il s’agit non seulement d’organiser la vie mais plus précisément d’éterniser la vie par une action rémunératrice et permanente ; il s’agit d’aimer l’action en vue de rendre culte à Dieu, il s’agit enfin d’exiger de la conscience un centre d’attraction où tous les jeux de perfectionnement sont autorisés',
          source: 'Al Macktoom'
        },
        {
          id: 'c3',
          text: 'Le plus grand ennemi de l’homme c’est l’ignorance, bien sûr l’ignorance n’est pas forcément une absence de culture, mais les éléments d’une culture dont on ne se sert pas est aussi un signe inquiétant de l’ignorance',
          source: 'Al Macktoom'
        },
        {
          id: 'c4',
          text: 'Si la prière cesse d’être sacralisation de nos actes quotidiens, malheur à ceux qui, par ignorance, en deviennent les victimes. Car la prière est à l’âme ce que l’engrais est à la surface du sol ; ou elle l’améliore ou elle l’écrase. C’est une question de dosage, une question de discernement, c’est surtout une question d’éducation mystique.',
          source: 'Al Macktoom'
        },
        {
          id: 'c5',
          text: 'Dieu, c’est l’ensemble de tout ce qui existe ; ce qui veut dire que la religion peut être considérée comme une perpétuelle tension tendant à maintenir un parfait équilibre pour la bonne grâce de tout ce qui existe.',
          source: 'Al Macktoom'
        },
        {
          id: 'c6',
          text: 'L’expérience démontre aisément que nous obéissons plutôt aux superstitions et à la tradition qu’à la doctrine pure dont nous avons hérité du Prophète. L’héritage de Mouhamed, c’est l’ensemble de toutes les vérités qui ont fait les héros du Ciel.',
          source: 'Al Macktoom'
        },
        {
          id: 'c7',
          text: 'L’Islam n’est qu’un tremplin, et le plus sûr pour guider l’humanité vers le salut.',
          source: 'Al Macktoom'
        },
        {
          id: 'c8',
          text: 'L’Islam peut être considéré comme une aventure passionnante ; aventure qui a pour point de départ le ventre maternel et qui ne saurait prendre fin qu’avec les flancs inconsolables de la tombe.',
          source: 'Al Macktoom'
        },
        {
          id: 'c9',
          text: 'Le Livre Sacré de Dieu ne contient pas seulement nos devoirs, les règles et façons de nous dévouer au Tout Puissant. Il contient en substance comme un plan, un guide, une succession chronologique de tout ce que l’être humain a déjà tenté, tout ce qu’il a réussi et tout ce que son esprit peut fouiller dans l’insondable univers.',
          source: 'Al Macktoom'
        },
        {
          id: 'c10',
          text: 'Maîtriser le verbe de sorte qu’il reste le fondement du dialogue, dialogue entre créature et Créateur, dialogue entre les hommes, dialogue entre la société et la nature ; mais que ce dialogue soit authentifié par une action concrète et parfaitement réaliste.',
          source: 'Al Macktoom'
        },
        {
          id: 'c11',
          text: 'Une vie sans religion est une vie sans principes et une vie sans principes est un bateau sans gouvernail.',
          source: 'Al Macktoom'
        },
        {
          id: 'c12',
          text: 'Un homme juste et doté de l’intelligence non matérielle ne peut qu’admettre et qu’affirmer que l’Islam est la religion actuelle de tous les êtres humains.',
          source: 'Al Macktoom'
        },
        {
          id: 'c13',
          text: 'Il faut rénover les méthodes de pratiques religieuses plutôt que l’Islam lui-même, car nous croyons que nos déformations sont nées plus de l’analphabétisme et de l’incompréhension des adeptes que de la structure même de l’Islam.',
          source: 'Al Macktoom'
        },
        {
          id: 'c14',
          text: 'L’Islam sénégalais s’étouffe sous la contrainte des traditions animistes comme le christianisme sous la « pression » du paganisme romain. La parole de Dieu et la prédication du féticheur se confondent. L’âme du musulman sénégalais est condamnée dans l’incertitude. Le bien et le mal n’existent que pour s’incliner devant la volonté du charlatan.',
          source: 'Al Macktoom'
        },
        {
          id: 'c15',
          text: 'La religion en tant que source de grâce, la religion en tant qu’attitude de la créature à l’égard de son créateur, attitude à la fois raisonnable et raisonnée, la religion en tant que comportement social parce qu’elle est les trois à la fois, méritait de notre part beaucoup plus d’attention.',
          source: 'Al Macktoom'
        },
        {
          id: 'c16',
          text: 'Si l’Islam devait reposer sur d’autres principes que ceux de la culture approfondie, il appartiendrait à la jeunesse de tout mettre en œuvre pour cueillir les fruits de la culture. Elle pourrait même si elle ne comprenait pas l’arabe, se faire traduire des préceptes en sa langue propre…',
          source: 'Al Macktoom'
        },
        {
          id: 'c17',
          text: 'La meilleure idéologie pour un sénégalais c’est de rester sénégalais.',
          source: 'Al Macktoom'
        },
        {
          id: 'c18',
          text: 'Être trop juif, trop chrétien, trop musulman, cela risque de nous basculer dans le vide du sectarisme. Soyons partisan de Dieu si nous voulons vivre en paix.',
          source: 'Al Macktoom'
        },
        {
          id: 'c19',
          text: 'Il s’agit pour l’occident, d’une technique qui cherche sa conscience et pour l’Islam, d’une conscience qui cherche sa technique. Seule une coopération serait en mesure d’aider à réaliser une telle jonction.',
          source: 'Al Macktoom'
        },
        {
          id: 'c20',
          text: 'Souvent on a besoin d’être stratège pour gouverner, des fois, il faut être tacticien, parfois homme de Dieu et dès fois Homme au vrai sens du terme.',
          source: 'Al Macktoom'
        },
        {
          id: 'c21',
          text: 'Il est difficile dans un pays tel que le Sénégal de vouloir pratiquer un Islam pur et dur (…). Il ne peut y avoir qu’un Islam négocié.',
          source: 'Al Macktoom'
        },
        {
          id: 'c22',
          text: 'Si l’espoir des femmes et des enfants ne se dirigent que vers les cimetières alors l’homme n’a plus de droit de goûter le plaisir conjugal.',
          source: 'Al Macktoom'
        },
        {
          id: 'c23',
          text: 'Concevoir un monde sans obstacle, c’est ignorer la nature des choses, et l’homme se découvre quant-il se mesure à l’obstacle.',
          source: 'Al Macktoom'
        },
        {
          id: 'c24',
          text: 'Les confréries sont des clubs mystiques où se forment continuellement les athlètes de la religion.',
          source: 'Al Macktoom'
        },
        {
          id: 'c25',
          text: 'L’essentiel c’est de mettre l’accent sur ce que l’Islam appelle « AL HAQAA-IQAL KOUBRA », c’est-à-dire les grandes réalités. Les réalités de tous les temps et de tous les siècles et qui veulent que l’homme ait pour objectif principal la réalisation de l’unité profonde et organique de la création.',
          source: 'Al Macktoom'
        },
        {
          id: 'c26',
          text: 'Le Coran contient en substance comme un plan, un guide, une succession chronologique, tout ce que l’être humain a déjà tenté, tout ce qu’il a réussi et tout ce que son esprit peut fouiller dans l’insondable univers.',
          source: 'Al Macktoom'
        },
        {
          id: 'c27',
          text: 'Il est dix fois plus aisé d’être simple dispensateur d’injures que d’être contestataire de vocation.',
          source: 'Al Macktoom'
        }
